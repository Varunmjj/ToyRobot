# ToyRobot
Toy Robot that moves in a designated play area, written in C# dot net core 6

#To Run
The project contains a file input.txt , the file needs to be updated with the input commands to run.
